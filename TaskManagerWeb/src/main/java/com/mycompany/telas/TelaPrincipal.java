...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void NovaTarefaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NovaTarefaButtonActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao abrir a tela de nova tarefa: " + ex.getMessage());
        }
...
try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao abrir a tela de exibição de tarefas: " + ex.getMessage());
        }
